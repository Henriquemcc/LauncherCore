...
interface ISolderApi {
    @Throws(RestfulAPIException::class)
    fun getSolderPack(solderRoot: String?, modpackSlug: String?, mirrorUrl: String?): ISolderPackApi

    @Throws(RestfulAPIException::class)
    fun getPublicSolderPacks(solderRoot: String): Collection<SolderPackInfo?>?

    @Throws(RestfulAPIException::class)
    fun getMirrorUrl(solderRoot: String?): String?

    @Throws(RestfulAPIException::class)
    fun internalGetPublicSolderPacks(solderRoot: String, packFactory: ISolderApi): Collection<SolderPackInfo?>?
}