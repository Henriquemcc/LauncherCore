...
class SolderPackInfo : RestObject(), PackInfo {
    override val name: String? = null
    override val displayName: String? = null
    private val url: String? = null
    override val icon: String?
        get() = null
    private val icon_md5: String? = null
    override val logo: String?
        get() = null
    private val logo_md5: String? = null
    override val background: String?
        get() = null
    private val background_md5: String? = null
    override val recommended: String? = null
    override val latest: String? = null
    override val builds: List<String?>? = null

    @Transient
    var solder: ISolderPackApi? = null
    ...
    override fun isLocal(): Boolean {
        return if (builds!!.size == 0) true else isLocal
    }
