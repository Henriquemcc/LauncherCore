...
class Server : RestObject() {
    ...
    private val members: List<MemberInfo>? = null
    private val channels: List<ChannelInfo>? = null
    private val presence_count = 0
    fun getChannelCount(): Int {
        return channels!!.size
    }

    fun getFirstChannel(): ChannelInfo? {
        return if (channels!!.size == 0) null else channels[0]
    }
    ...
    fun getMember(index: Int): MemberInfo {
        return members!![index]
    }

    fun getPresenceCount(): Int {
