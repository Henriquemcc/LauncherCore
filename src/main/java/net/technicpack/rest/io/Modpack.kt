...
class Modpack : RestObject {
    var gameVersion: String? = null
        private set
    val java: String? = null
    val memory: String? = null
    private var mods: MutableList<Mod>? = null

    constructor() {}
    constructor(info: PlatformPackInfo) {
        gameVersion = info.gameVersion
        mods = java.util.ArrayList<Mod>()
        val mod = Mod(info.name, info.recommended, info.url, "")
        mods!!.add(mod)
    }
