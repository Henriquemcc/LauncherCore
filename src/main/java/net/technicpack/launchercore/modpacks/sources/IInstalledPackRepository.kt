...
open interface IInstalledPackRepository {
    fun getInstalledPacks(): Map<String?, InstalledPack?>
    fun getPackNames(): List<String?>
    fun getSelectedSlug(): String?
    fun setSelectedSlug(slug: String?)
    fun put(installedPack: InstalledPack?): InstalledPack?
    fun remove(name: String?): InstalledPack?
    fun save()
}