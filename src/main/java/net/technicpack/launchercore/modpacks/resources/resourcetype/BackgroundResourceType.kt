...
class BackgroundResourceType constructor() : IModpackResourceType {
    public override fun getResource(modpack: ModpackModel): Resource? {
        return modpack.getBackground()
    }

    public override fun getImageName(): String {
