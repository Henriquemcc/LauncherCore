...
class PackLoader constructor(
    ...
    fun createRepositoryLoadJob(
        container: IModpackContainer,
        packSources: Collection<IPackSource>?,
        tagBuilder: IModpackTagBuilder?,
        doLoadRepository: Boolean
    ): PackLoadJob {
        val job: PackLoadJob = PackLoadJob(
            directories,
            packRepository,
            authoritativeSource,
            packSources,
