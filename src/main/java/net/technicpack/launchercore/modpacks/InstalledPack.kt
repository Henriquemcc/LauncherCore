...
class InstalledPack constructor() {
    private var name: String? = null
    private var build: String?
    private var directory: String? = null

    @JvmOverloads
    constructor(name: String?, build: String?, directory: String? = MODPACKS_DIR + name) : this() {
        this.name = name
        this.build = build
    ...
    companion object {
        val RECOMMENDED: String = "recommended"
        val LATEST: String = "latest"
        val LAUNCHER_DIR: String = "launcher\\"
        val MODPACKS_DIR: String = "%MODPACKS%\\"
    }
}