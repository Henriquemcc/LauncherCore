...
open interface IImageStore<T> {
    fun canDownloadImage(key: T, target: File?): Boolean
    fun downloadImage(key: T, target: File)
    fun getJobKey(key: T): String
    fun canRetry(key: T): Boolean
}