...
class CheckRundataFile constructor(
    private val modpackModel: ModpackModel,
    private val modpack: Modpack,
    private val writeRunDataGroup: TaskGroup
) : IInstallTask {
    ...
    public override fun runTask(queue: InstallTasksQueue<*>?) {
        ...
        if (modpackModel.isLocalOnly()) return
        writeRunDataGroup.addTask(WriteRundataFile(modpackModel, modpack))
    }
}