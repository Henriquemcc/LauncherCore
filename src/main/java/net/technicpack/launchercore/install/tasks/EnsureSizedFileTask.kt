...
class EnsureSizedFileTask : EnsureFileTask<IWeightedTasksQueue> {
    ...
    constructor(
        ...
        sourceUrl: String?,
        downloadTaskQueue: IWeightedTasksQueue,
        copyTaskQueue: IWeightedTasksQueue,
        fileSize: Int
    ...
    public override fun unzipFile(
        taskQueue: IWeightedTasksQueue,
        zipLocation: File,
        targetLocation: File?,
        filter: IZipFileFilter?
    ) {
        taskQueue.addNextTask(UnzipFileTask(zipLocation, targetLocation, filter), fileSize.toFloat())
    }

    public override fun downloadFile(
        taskQueue: IWeightedTasksQueue,
        sourceUrl: String?,
        targetLocation: File?,
        ...
        taskQueue.addNextTask(DownloadFileTask(sourceUrl, targetLocation, verifier, fileName), fileSize.toFloat())
    }
}