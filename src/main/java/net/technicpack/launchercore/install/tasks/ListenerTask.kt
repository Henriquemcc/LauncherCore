...
abstract class ListenerTask constructor() : IInstallTask, DownloadListener {
    private var taskProgress: Float = 0f
    private var queue: InstallTasksQueue<*>? = null
    ...
    protected fun setQueue(queue: InstallTasksQueue<*>?) {
        this.queue = queue
    }

    public override fun stateChanged(fileName: String?, progress: Float) {
