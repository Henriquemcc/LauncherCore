...
abstract class LauncherDirectories constructor() {
    abstract fun getLauncherDirectory(): File
    abstract fun getCacheDirectory(): File?
    abstract fun getAssetsDirectory(): File?
    abstract fun getModpacksDirectory(): File
}