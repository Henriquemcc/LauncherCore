...
class ModpackInstaller<VersionData> constructor(private val platformApi: IPlatformApi, private val clientId: String) {
    @Throws(IOException::class, InterruptedException::class)
    fun installPack(tasksQueue: InstallTasksQueue<VersionData>, modpack: ModpackModel, build: String?): VersionData? {
        modpack.save()
        modpack.initDirectories()
        val installedVersion: Version? = modpack.getInstalledVersion()
        tasksQueue.runAllTasks()
        val versionFile: Version = Version(build, false)
