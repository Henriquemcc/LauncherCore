...
class ValidateResponse : RestObject {
    private var valid: Boolean = false
    private var message //error message
            : String? = null
    private val clientToken: String? = null
    private val accessToken: String? = null
    private val downloadToken: String? = null
