...
class SecureToken constructor(private val userModel: UserModel<*>, private val mirror: ISecureMirror) {
    private val token: String? = null
    private val receivedTime: Date? = null
    private val tokenUserName: String? = null
    private val tokenAccessToken: String? = null
    fun getDownloadHost(): String? {
        return mirror.getDownloadHost()
    }

    @Throws(DownloadException::class)
    fun queryForSecureToken(): String? {
        return null
    }
}