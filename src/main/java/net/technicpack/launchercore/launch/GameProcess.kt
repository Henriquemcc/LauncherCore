...
class GameProcess constructor(private val commands: List<String>, private val process: Process) {
    private var exitListener: ProcessExitListener? = null
    private val monitorThread: ProcessMonitorThread
    ...
    init {
        ...
        monitorThread = ProcessMonitorThread(this)
        monitorThread.start()
    }

    fun getExitListener(): ProcessExitListener? {
        return exitListener
    }

    fun setExitListener(exitListener: ProcessExitListener?) {
