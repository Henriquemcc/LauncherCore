...
class BuildLogFormatter constructor(launcherBuild: String) : Formatter() {
    ...
    public override fun format(record: LogRecord): String {
        ...
        builder.append(" [")
        builder.append(record.getLevel().getLocalizedName().uppercase(Locale.getDefault()))
        builder.append("] ")
        builder.append(formatMessage(record))
        builder.append('\n')
        if (record.getThrown() != null) {
            val writer: StringWriter = StringWriter()
            record.getThrown().printStackTrace(PrintWriter(writer))
