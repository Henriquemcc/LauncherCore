...
object TechnicConstants {
    val technicURL: String = "http://mirror.technicpack.net/Technic/"
    val technicVersions: String = technicURL + "version/"
    private var buildNumber: IBuildNumber? = null
    private var userAgent: String? = null
    fun getBuildNumber(): IBuildNumber? {
        return buildNumber
    }

    fun setBuildNumber(buildNumber: IBuildNumber) {
