...
interface IPlatformApi {
    ...
    fun getPlatformPackInfoForBulk(packSlug: String?): PlatformPackInfo?

    @Throws(RestfulAPIException::class)
    fun getPlatformPackInfo(packSlug: String?): PlatformPackInfo?
    fun incrementPackRuns(packSlug: String)
    fun incrementPackInstalls(packSlug: String?)

    @Throws(RestfulAPIException::class)
    fun getNews(): NewsData?
    fun getPlatformUri(slug: String?): String?
}