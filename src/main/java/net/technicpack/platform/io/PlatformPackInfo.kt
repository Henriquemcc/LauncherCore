...
class PlatformPackInfo : RestObject(), PackInfo {
    private override val name: String? = null
    private override val displayName: String? = null
    private val url: String? = null
    private val platformUrl: String? = null
    private override val icon: Resource? = null
    private override val logo: Resource? = null
    private override val background: Resource? = null
    private val minecraft: String? = null
    private val forge: String? = null
    private val version: String? = null
    private val solder: String? = null
    private override val description: String? = null
    private val ratings: Int? = null
    private override val runs: Int? = null
    private override val downloads: Int? = null
    private val forceDir = false
    private val isServer = false
    private override val isOfficial = false
    private val discordServerId: String? = null
    private override val feed = ArrayList<FeedItem?>()

    @Transient
    private override var isLocal = false
    ...
    override fun getIcon(): Resource? {
        return icon
    }

    override fun getBackground(): Resource? {
        return background
    }

    override fun getLogo(): Resource? {
        return logo
    }

    override fun getRecommended(): String? {
        return version
    }
    ...
    override fun getFeed(): ArrayList<FeedItem?>? {
        return feed
    }

    override fun getDiscordId(): String? {
        return discordServerId
    }

    override fun getBuilds(): List<String?>? {
        val builds: MutableList<String?> = ArrayList()
        builds.add(version)
        return builds
    }
    ...
    fun getSolder(): String? {
        return solder
    }

    fun hasSolder(): Boolean {
        return solder != null && solder != ""
    }
    ...
    override fun isServerPack(): Boolean {
        return isServer
    }
    ...
    override fun isOfficial(): Boolean {
        return isOfficial
    }
