...
object ImageUtils {
    fun scaleWithAspectWidth(img: BufferedImage, width: Int): BufferedImage {
        val imgWidth: Int = img.getWidth()
        val imgHeight: Int = img.getHeight()
        val height: Int = imgHeight * width / imgWidth
        return scaleImage(img, width, height)
    }

    fun scaleImage(img: BufferedImage?, width: Int, height: Int): BufferedImage {
        val newImage: BufferedImage = BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB)
    ...
    fun scaleWithAspectHeight(img: BufferedImage, height: Int): BufferedImage {
        val imgWidth: Int = img.getWidth()
        val imgHeight: Int = img.getHeight()
        val width: Int = imgWidth * height / imgHeight
        return scaleImage(img, width, height)
    }
}